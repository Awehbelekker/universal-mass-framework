...
Write-Host "Running: firebase deploy --only firestore:rules" -ForegroundColor DarkGray
...
Write-Host "Running: firebase deploy --only hosting" -ForegroundColor DarkGray
...
Write-Host "Admin credentials: admin@prometheus-trading.com - Password: PrometheusAdmin2025!" -ForegroundColor Yellow
